    ...
    <div >
       ...
       <div class="content">
            <div class="search">
                ...
                <div >
                    <input class="sinput_w"    placeholder="请输入查询内容" @focus="inputtext"/>
                </div>
            </div>
            ...
            <div class="items" v-for="count in 10">
                <div class="item">
                    <div class="img"><img src="../../img/user.jpg"/>
                        <span class="spot" v-if="count%3==0"> </span>
                        <span class="spot_w" v-if="count%3==1">{{count}}</span>
...
<style lang="scss" scoped>
    ...
    .top{
        ...
        .text{
             ...
             .icon{
                @include fontStyle(1.5rem,2.73rem);
                position: absolute;
                 color:rgb(0, 0, 0);
                top: 0px;
                right: 0;
