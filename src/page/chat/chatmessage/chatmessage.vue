  ...
  <div class="body">
    ...
    <div class="content"
      ...
      <div class="chat">
        ...
        <div class="recevice"
          ...
          <div :class="values.name=='czm'?'item':'ritem'"
               v-for="(values,indexs) in value">
            <img src="../../../img/me.jpg"
                 class="img" />
            <div>
              <svg class="svgs">
                <use xmlns:xlink="http://www.w3.org/1999/xlink"
                     :xlink:href="values.name=='czm'?'#trigon-left':'#trigon-right'"></use>
              </svg>
              <div class="text">
                {{values.content}}
              </div>
    ...
    <div :class="bottom_ext==false?'footer':'footer bottom'">
      <div class="contents">
        <svg class="svg_v">
          <use xmlns:xlink="http://www.w3.org/1999/xlink"
               xlink:href="#voice"></use>
        </svg>
        <textarea class="svg_input"
                  @keydown.enter="send"
                  v-model="input_t" />
        <div class="svg_o">
          <svg class="face">
          ...
          <svg class="addthing"
               @click="this.bottom_show">
            <use xmlns:xlink="http://www.w3.org/1999/xlink"
                 xlink:href="#addthing"></use>
          </svg>
